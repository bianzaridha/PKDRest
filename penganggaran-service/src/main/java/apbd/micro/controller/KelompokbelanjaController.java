...
import apbd.micro.model.KelompokBelanja;
import apbd.micro.proxy.KelompokBelanjaProxy;
...
public class KelompokbelanjaController {
    ...
    public KelompokBelanja insert(@RequestBody KelompokBelanjaProxy kbp){
        KelompokBelanja kb = new KelompokBelanja(
                        kegserv.findById(kbp.getId_kegiatan()).get(0),
                        kbp.getId(),
                        kbp.getAkun(),
                        kbp.getNama());
